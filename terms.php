...
<head>
	...
	<title>Terms of Service | Voteryte</title>
			...
			<div class="row">
				<div class="col-12 col-lg-8 justify-content-center">
					...
					<p>
							...
							voteryte nig ltd is committed to ensuring that the app
							...
							The voteryte app stores and processes personal data
							...
							voteryte app won’t work properly or at all.
						</p> <p>
							You should be aware that there are certain things that
							voteryte nig ltd will not take responsibility for.
							...
							voteryte nig ltd cannot take responsibility for the
							...
							Along the same lines, voteryte nig ltd cannot always
							...
							Service, voteryte nig ltd cannot accept
							responsibility.
						</p> <p>
							With respect to voteryte nig ltd’s responsibility for
							...
							voteryte nig ltd accepts no liability for any loss,
							direct or indirect, you experience as a result of relying
							wholly on this functionality of the app.
						</p> 
						
					<p class="mt-4"><strong>Changes to This Terms and Conditions</strong></p> <p>
					...
					<p class="mt-4"><strong>Contact Us</strong></p> <p>
							...
							contact us at hello@voteryte.io.
						</p>
				</div>
			</div>
	</div>
